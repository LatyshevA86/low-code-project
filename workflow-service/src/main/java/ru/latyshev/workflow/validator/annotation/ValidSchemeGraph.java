...
import ru.latyshev.workflow.validator.ValidSchemeGraphValidator;
...
@Constraint(validatedBy = ValidSchemeGraphValidator.class)
public @interface ValidSchemeGraph {
